...
class _AdminProductsPageState extends State<AdminProductsPage> {
  ...
  Widget _buildProductCard(
      Product product, Color textColor, Color secondaryText) {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 8),
                      Icon(Icons.layers_outlined, size: 13, color: secondaryText),
  ...
  Widget _productIconPlaceholder() {
    return Center(
      child: Icon(Icons.shopping_bag_outlined,
          color: primaryRed.withValues(alpha: 0.5), size: 28),
    );
  }
}
